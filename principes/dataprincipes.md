...
|-----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| F1. Objecten krijgen een wereldwijd unieke en persistente identifier                        | Deze UOI is onderdeel van de (Meta)data bij ieder fysiek object binnen het DSGO welke geldig blijft tijdens de hele levenscyclus van het object                                                                                                                    |
...
| F4. (Meta)data worden geregistreerd of geïndexeerd in een doorzoekbare bron                   | Het DSGO heeft een catalogusfunctie met gedistribueerde data(sets) over de gebouwde omgeving                                                                                                                                                                            |
